...
echo "2. From this dev machine, run the health check:"
echo "   uv run python spark/health_check.py spark://$MASTER_PRIVATE_IP:7077"
echo ""
echo "   Or SSH to master and run the installation test:"
echo "   ssh -i $KEY_FILE ubuntu@$MASTER_PUBLIC_IP"
echo "   cd ~/spark-cluster"
echo "   uv run python spark_installation_test.py"
echo ""
