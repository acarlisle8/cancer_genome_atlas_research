...
# Marker panels live in src/markers so merge.py and this audit stay aligned.
from src.markers import PAM50_BRCA, LUAD_MARKERS, PRAD_MARKERS, PANELS  # noqa: F401
